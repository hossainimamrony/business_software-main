...
from .models import AddProduct,Brand,Category,Warranty,Unit,SubCategory,VariationType,VariationValue,ProductVariation,ProductVariationValue
...
class VariationType_Serializer(serializers.ModelSerializer):
    class Meta:
        model=VariationType
        fields=('__all__')


class VariationValue_Serializer(serializers.ModelSerializer):
    class Meta:
        model=VariationValue
        fields=('__all__')


class ProductVariation_Serializer(serializers.ModelSerializer):
    class Meta:
        model=ProductVariation
        fields=('__all__')


class ProductVariationValue_Serializer(serializers.ModelSerializer):
    product_variation = ProductVariation_Serializer()
    class Meta:
