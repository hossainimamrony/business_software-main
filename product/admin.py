...
from .models import AddProduct,Brand,Category,Warranty,Unit,SubCategory,VariationType,VariationValue,ProductVariation,ProductVariationValue,OpeningStock
...
class VariationType_Column_Display(admin.ModelAdmin):
    list_display=field_names = (
    'name',
)
admin.site.register(VariationType,VariationType_Column_Display)


class VariationValue_Column_Display(admin.ModelAdmin):
    list_display=field_names = (
    'variation_type',
    'value',
)
admin.site.register(VariationValue,VariationValue_Column_Display)


class ProductVariation_Column_Display(admin.ModelAdmin):
    list_display=field_names = (
    'variation_type',
    'variation_value',
    'applicable_tax_name',
...
admin.site.register(ProductVariation,ProductVariation_Column_Display)


class ProductVariationValue_Column_Display(admin.ModelAdmin):
    list_display=field_names = (
    'product_variation',
    'exc_tax',
    'inc_tax',
...
admin.site.register(ProductVariationValue,ProductVariationValue_Column_Display)
